package com.goat.jdk.learn.chapter005.A050.example02;
...
public class TestNG {
    ...
    */
    ...
    // 枚举类 valueOf 异常：No enum constant com.goat.jdk.learn.chapter005.A050.example02.Weekday.fuck
    @Test
    public void test5(){
        System.out.println(Weekday.valueOf("fuck"));
    }

    /** Weekday.values()方法  遍历枚举类   枚举遍历
